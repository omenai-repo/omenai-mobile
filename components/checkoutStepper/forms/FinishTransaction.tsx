    ...
    <View>
      ...
      {!loading && verified && (
        <View>
          ...
          {success !== null && (
            <Image
              style={{ height: 100, marginHorizontal: 'auto', marginTop: 10, marginBottom: 30 }}
              resizeMode="contain"
              source={success ? successImage : errorImage}
            />
          )}
          <LongBlackButton value="View subscription" onClick={handleViewSubscription} />
        </View>
      )}
    </View>
  );
