      ...
      <View style={styles.formContainer}>
        <CustomSelectPicker
          ...
          handleSetValue={(e: any) =>
            handleInputChange({ name: "country", value: e.value })
          }
          zIndex={90}
        />
        <CustomSelectPicker
          ...
          data={selectStates}
          handleSetValue={(e: any) =>
            handleInputChange({ name: "state", value: e.value })
          }
          zIndex={50}
        />
        ...
        <View style={{ zIndex: 10 }}>
          <Input
            label="Address"
            onInputChange={(e) =>
              handleInputChange({ name: "address", value: e })
            }
        ...
        <View style={{ zIndex: 10 }}>
          <Input
            label="Zip code"
            onInputChange={(e) =>
              handleInputChange({ name: "zipcode", value: e })
            }
