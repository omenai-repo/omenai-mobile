...
export default function ProvideShippingQuoteModal() {
    ...
    const [formErrors, setFormErrors] = useState<shippingQouteFormErrorsType>({carrier: '', fees: '', taxes: ''});
    ...
    const handleSubmit = async () => {
        ...
        let data : ShippingQuoteTypes = {
            ...
            shipping_fees: acceptForm.fees,
            taxes: acceptForm.taxes
        };
        
        const results = await updateShippingQuote({data: data, order_id: currentId})
