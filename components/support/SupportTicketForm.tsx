    ...
    >
      ...
      {!isLoggedIn && (
        <View style={tw`mb-4`}>
          ...
          <TextInput
            style={tw`border border-gray-300 rounded-lg p-3 text-black bg-gray-50`}
            value={guestEmail}
      ...
      {showDateField && (
        <View style={tw`mt-4`}>
          ...
          <TouchableOpacity
            ...
            style={tw`border border-gray-300 rounded-lg p-3 bg-gray-50 flex-row justify-between items-center`}
          >
      ...
      <TextInput
        style={tw`border border-gray-300 rounded-lg p-3 mb-6 h-32 text-black bg-gray-50 text-base`}
        value={message}
