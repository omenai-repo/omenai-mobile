    ...
    >
      ...
      <View style={tw`w-full max-w-[600px] items-center`}>
        ...
        <View style={tw`mb-8 relative`}>
          ...
          />
          <View
            style={tw`relative w-20 h-20 bg-[#0f172a] border border-[#47748E]/30 rounded-md items-center justify-center shadow-2xl`}
          >
            <Animated.View
              style={{
          ...
          <View style={tw`w-full max-w-[500px]`}>
            ...
            <View style={tw`flex-row gap-4 justify-center`}>
              ...
              <View style={tw`flex-1 items-center`}>
                <View
                  style={tw`relative bg-[#0f172a]/50 border border-[#47748E]/20 rounded-md w-full h-20 items-center justify-center overflow-hidden`}
                >
              ...
              <View style={tw`flex-1 items-center`}>
                <View
                  style={tw`relative bg-[#0f172a]/50 border border-[#2A9EDF]/30 rounded-md w-full h-20 items-center justify-center overflow-hidden shadow-lg`}
                >
