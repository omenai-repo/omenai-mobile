...
import { warningIconSm } from "#utils/assets/SvgImages";
      ...
      >
        ...
        >
          ...
          <Text style={tw`text-[14px] text-[#1A1A1A] text-center mx-[30px]`}>
            Please ensure that all the information provided is accurate and
            correctly reflected in your CV/Resume, as it will directly impact
            the outcome of your account verification.
          </Text>
          ...
          <View style={tw`mt-[30px]`}>
            <FittedBlackButton
              onClick={confirmBtn}
              value="I understand and I wish to Proceed"
            />
          </View>
        </Pressable>
      </Pressable>
