...
import OrderActions, { getOrderActionType } from 'components/orders/OrderActions';
...
export const OrderContainer = (props: OrderContainerProps) => {
  ...
  React.useEffect(() => {
    const actionType = getOrderActionType({
      status,
      payment_status,
      tracking_status,
      order_accepted,
    });
    const wantsButtons = actionType === 'track' || actionType === 'action';
    const targetHeight =
