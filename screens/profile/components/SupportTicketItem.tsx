...
export const SupportTicketItem = ({ item }: SupportTicketItemProps) => {
  ...
  return (
    <View
      style={tw`bg-white p-4 rounded-md border border-gray-100 mb-3 shadow-sm`}
    >
      <View style={tw`flex-row justify-between items-start mb-2`}>
        <View>
          <View style={tw`bg-gray-100 px-2 py-1 rounded-md self-start mb-1`}>
      ...
      >
        ...
        <View style={tw`flex-row items-center gap-1`}>
          <Text
            style={[
              tw`text-[10px] font-bold uppercase px-2 py-0.5 rounded-md border`,
              priorityStyle,
            ]}
          >
            {item.priority}
