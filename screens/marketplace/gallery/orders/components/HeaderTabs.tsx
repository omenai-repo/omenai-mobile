...
import { galleryOrdersStore, galleryOrdersTab } from "#store/marketplace/gallery/galleryOrdersStore";
      ...
      <View style={styles.container}>
        ...
        <View style={styles.mainContainer}>
          {tabs.map((tab: galleryOrdersTab, index: number) => (
            ...
            >
              <View style={[styles.item, tab === selectedTab && { backgroundColor: colors.black }]}>
                <Text
                  style={{
