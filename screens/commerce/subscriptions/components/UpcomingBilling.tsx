...
import { getFutureDate } from "#utils/date/utils_getFutureDate";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.bottomContainer}>
        {sub_status === "canceled" ? (
          <View>
            <Text style={{ fontSize: 12, color: "#ff0000", marginBottom: 10 }}>
          ...
          <View>
            ...
            >
              ...
              >
                <Image
                  source={images.omenaiLogoCut}
                  style={styles.omenaiLogo}
                />
                <View style={{ gap: 5 }}>
                  <Text
                    style={{
              ...
              <View style={{ alignItems: "flex-end", gap: 5 }}>
                ...
                >
                  {utils_formatPrice(next_charge_params.value, currency_symbol)}
                </Text>
                <Text
                  style={{
                    fontSize: 14,
                ...
                >
                  {next_charge_params.interval.replace(/^./, (char) =>
                    char.toUpperCase(),
                  )}
                </Text>
              </View>
            </View>
            <Text style={{ color: colors.grey, marginTop: 15 }}>
              <Text style={{ fontWeight: 500, color: colors.primary_black }}>
                From:
              </Text>{" "}
              ...
              {getFutureDate(end_date, next_charge_params.interval)}
            </Text>
          </View>
        )}
      </View>
