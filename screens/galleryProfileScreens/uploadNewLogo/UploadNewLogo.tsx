    ...
    const handleUpload = async () => {
        ...
        try{
            ...
            if (logoUpdated) {
                ...
                if (!isOk){
                    updateModal({message: body.message, modalType: 'error', showModal: true})
                }else{
                    updateModal({message: `${body.message}... Please log back in`, modalType: 'success', showModal: true})
                    handleLogout()
                }
            }
        }catch(error){
            updateModal({message: 'An error occured, please try again', modalType: 'error', showModal: true})
        }
