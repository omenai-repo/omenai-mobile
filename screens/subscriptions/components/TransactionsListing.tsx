...
export default function TransactionsListing() {
  ...
  if (isLoading) {
    return (
      <View
        style={tw`bg-white rounded-md border border-slate-200 p-6 items-center justify-center`}
      >
        <ActivityIndicator />
  ...
  if (isError) {
    return (
      <View style={tw`bg-white rounded-md border border-slate-200 p-6`}>
        <Text style={tw`text-base font-semibold text-slate-900 mb-2`}>
          Recent Transaction Activity
        </Text>
        <View
          style={tw`items-center justify-center py-10 rounded-md bg-red-50 border border-red-200`}
        >
  ...
  return (
    <View
      style={[tw`bg-white rounded-md border border-slate-200 p-6`, shadow()]}
    >
...
function Row({ item, index }: { item: Txn; index: number }) {
  ...
  return (
    <View style={tw`relative flex-row items-start pb-3`}>
      ...
      {/* card */}
      <View style={tw`flex-1 bg-slate-50 rounded-md p-4`}>
