      ...
      <View style={styles.container}>
        ...
        {cardType !== null && (
          <View style={styles.logoContainer}>
            ...
            {cardType === "visa" && (
              <Image source={visa} style={styles.logo} resizeMode="contain" />
            )}
            {cardType === "verve" && (
              <Image source={verve} style={styles.logo} resizeMode="contain" />
            )}
          </View>
        )}
      </View>
      {error && (
        <Text style={{ fontSize: 12, color: "#ff000070" }}>{error}</Text>
      )}
    </View>
  );
}
