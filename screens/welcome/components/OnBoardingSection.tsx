...
export default function OnBoardingSection({data, handleNext, currentIndex, onFinish}: onBoardingSectionProps) {
    return (
            ...
            <View style={styles.imageContainer}>
                ...
                <SafeAreaView style={styles.safeArea}>
                    <View style={styles.indicators}>
                        {[0,1,2].map(i => <View style={[styles.indicator, i <= currentIndex && {opacity: 1}]} key={i} />)}
                    </View>
                </SafeAreaView>
            </View>
