...
import QuestionContainer from "#components/auth/artistOnboarding/QuestionContainer";
import CVUpload from "#components/auth/artistOnboarding/CVUpload";
import Socials from "#components/auth/artistOnboarding/Socials";
import OnboardingProgressBar from "#components/auth/artistOnboarding/OnboardingProgressBar";
import EditOnboardingModal from "#components/auth/artistOnboarding/EditOnboardingModal";
import uploadArtistDoc from "#screens/auth/register/components/artistRegistrationForm/uploadArtistDoc";
import { artistOnboarding } from "#services/auth/submitArtistOnboarding";
import { storage } from "#config/appwrite.client";
import { useModalStore } from "#store/account/modal/modalStore";
import LoadingContainer from "#components/auth/artistOnboarding/LoadingContainer";
import FirstScreen from "#components/auth/artistOnboarding/FirstScreen";
import SuccessComp from "#components/auth/artistOnboarding/SuccessComp";
import { useAppStore } from "#store/app/appStore";
import { logout } from "#utils/auth/logout.utils";
import SubmissionOverview from "#components/auth/artistOnboarding/SubmissionOverview";
...
import {
  questions,
  type QuestionKey,
} from "#components/auth/artistOnboarding/onboardingQuestions";
