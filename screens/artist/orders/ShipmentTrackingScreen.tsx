        ...
        >
          ...
          {trackingData && !isLoading && (
            <View style={tw`px-4 pb-8 space-y-4`}>
              ...
              {trackingData.artwork_data && (
                <View
                  style={tw`bg-white rounded-2xl px-4 py-3 flex-row items-center`}
                >
                  {image ? (
                    <Image
                      source={{ uri: image }}
              ...
              <View style={tw`bg-white rounded-2xl p-4 space-y-3`}>
                <View
                  style={tw`flex-row justify-between items-start mb-[10px]`}
                >
                  <View style={tw`flex-1 pr-2`}>
                    ...
                    <Text style={tw`text-black text-sm font-semibold mt-1`}>
                      {trackingData.shipping_details?.addresses.origin
                        .address_line || "N/A"}
                    </Text>
                  </View>
                ...
                <View
                  style={tw`flex-row justify-between items-center mb-[10px]`}
                >
                  <View>
                    <Text style={tw`text-gray-500 text-[16px] font-medium`}>
                      Carrier
                  ...
                  {primaryEventsToShow.map((event, idx) => {
                    ...
                    return (
                      <View
                        ...
                        style={tw`mb-${
                          originalIndex === eventsCount - 1 ? "0" : "6"
                        }`}
                      >
          ...
          {searchAttempted && !trackingData && !isLoading && (
            <View style={tw`px-4 py-8 items-center`}>
              ...
              <Text
                style={tw`text-black text-lg font-semibold text-center mb-2`}
              >
                Shipment Not Found
              </Text>
          ...
          {!searchAttempted && !trackingData && !isLoading && (
            <View style={tw`px-4 py-12 items-center`}>
              ...
              <Text style={tw`text-gray-500 text-sm text-center mt-2`}>
                Enter your tracking number above to view real-time shipment
                updates
              </Text>
            </View>
          )}
