...
export const WalletContainerSkeleton = () => {
  return (
    <View
      style={tw`bg-white border flex-row items-center p-[15px] mx-5 border-neutral-100 rounded-sm`}
    >
      <View style={tw`flex-row items-center gap-[15px] flex-1`}>
        <SkeletonBlock style={tw`w-12 h-12 rounded-sm`} />
...
export const AccountDetailsSkeleton = () => {
  return (
    <View style={tw`mt-5`}>
      <View
        style={tw`bg-white border border-neutral-100 rounded-sm px-5 py-3.5 mb-5`}
      >
