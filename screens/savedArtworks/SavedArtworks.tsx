  ...
  const SavedArtworkItem = ({
    ...
    return (
      <TouchableOpacity
        ...
        activeOpacity={0.9}
        style={tw`flex-row bg-white rounded-md overflow-hidden mb-4 border border-gray-100 shadow-sm`}
      >
        {/* Image Section */}
        ...
        <View style={tw`flex-1 p-3 justifying-between flex-col`}>
          ...
          <TouchableOpacity
            ...
            style={tw`flex-row items-center self-start bg-red-50 px-3 py-2 rounded-md gap-2 mt-auto`}
          >
