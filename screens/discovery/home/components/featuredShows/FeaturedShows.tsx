...
import { useFeaturedShows } from "#screens/marketplace/discovery/hooks/useFeaturedShows";
import { screenName } from "#constants/screenNames.constants";
import { getEventStatus } from "#services/marketplace/events/events.service";
                ...
                >
                  <View style={tw`relative`}>
                    <Image
                      ...
                      style={tw`w-full h-[170px] bg-[#EAEAEA]`}
                    />
                    <View style={tw`absolute top-3 left-3`}>
                      <Text
                        style={[
                          tw`px-2 py-1 text-[10px] uppercase tracking-widest font-medium`,
                          isClosed
