    ...
    return (
      <View style={styles.container}>
        <View style={styles.imageContainer}>
          <Image
            source={{
              uri: "/cloud.appwrite.io/v1/storage/buckets/66a0e9b3001b6f875e63/files/671627f6c24fcfbdb733/preview?width=500&height=0&gravity=center&quality=90&borderWidth=0&borderColor=FFFFFF&borderRadius=0&opacity=1&rotation=0&background=FFFFFF&output=webp&project=66a0e9130033484bb1c5",
            }}
