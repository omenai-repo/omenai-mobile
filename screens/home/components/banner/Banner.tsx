import { Dimensions, Image, StyleSheet, Text, View, NativeSyntheticEvent, NativeScrollEvent, FlatList, TouchableOpacity, Linking } from 'react-native'
...
export default function Banner({reloadCount}:{reloadCount: number}) {
        ...
        return(
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <Text style={{fontSize: 14, color: colors.white, marginTop: 7}}>{subheadline}</Text>
                    
                    <TouchableOpacity onPress={() => handleClick(cta)}>
                        <View style={{flexWrap: 'wrap'}}>
                            <View style={styles.button}><Text style={{fontSize: 14, fontWeight: '500', color: colors.white}}>View resource</Text></View>
                        </View>
                    </TouchableOpacity>
                </View>
            </View>
    ...
    return (
        <View>
            <View style={{backgroundColor: colors.primary_black, marginTop: 40, minHeight: 200}}>
